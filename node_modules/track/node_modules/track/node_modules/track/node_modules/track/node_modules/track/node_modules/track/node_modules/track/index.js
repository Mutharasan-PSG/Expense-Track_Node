...
const categories = ['Food', 'Transport', 'Utilities', 'Entertainment', 'Medical', 'Other'];
...
app.get('/edit_expense/:expense_id', async (req, res) => {
    ...
    res.render('edit_expense', { expense, expense_id: req.params.expense_id, categories });
});
...
app.get('/filter_expenses', async (req, res) => {
    if (!req.session.user_id) {
    ...
    try {
        ...
        res.json(filteredExpenses); // return filtered expenses to the frontend
    } catch (error) {
